...
import 'd_decryption_scan_barcode_page_model.dart';
export 'd_decryption_scan_barcode_page_model.dart';

class DDecryptionScanBarcodePageWidget extends StatefulWidget {
  const DDecryptionScanBarcodePageWidget({super.key});

  @override
  State<DDecryptionScanBarcodePageWidget> createState() =>
      _DDecryptionScanBarcodePageWidgetState();
}

class _DDecryptionScanBarcodePageWidgetState
    extends State<DDecryptionScanBarcodePageWidget> {
  late DDecryptionScanBarcodePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DDecryptionScanBarcodePageModel());
...
More about the official QR/Barcode Scanner you can find it [here](https://docs.flutterflow.io/actions/actions/widget-ui-interactions/scan-barcode-qr-code).''',
                  ...
                  if (_model.barcodeDataTextController.text != '')
                    TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Decrypted Barcode Data',
                        labelStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: 'Readex Pro',
                                  letterSpacing: 0.0,
